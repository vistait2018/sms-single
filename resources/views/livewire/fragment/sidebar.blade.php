<aside id="sidebar"
    ...
    <nav>
        ...
        <details class="group">
            ...
            <div class="pl-8 mt-1 space-y-1">
                <a href="{{  route('school.admin.school.classes') }}" class="block py-1 px-3 rounded hover:bg-purple-500 dark:hover:bg-gray-700 {{ request()->routeIs('school.admin.school.classes') ? 'bg-purple-500 dark:bg-purple-500' : '' }}">
                    School classes</a>
        ...
        <details class="group">
            ...
            <div class="pl-8 mt-1 space-y-1">
                <a href="{{  route('school.admin.school.student.registration') }}" class="block py-1 px-3 rounded hover:bg-purple-500 dark:hover:bg-gray-700 {{ request()->routeIs('admin.school.student.registration') ? 'bg-purple-500 dark:bg-purple-500' : '' }}">Register 
                     Student</a>
        ...
        <details class="group">
            ...
            <div class="pl-8 mt-1 space-y-1">
                <a href="{{  route('school.admin.school.teacher.registration') }}" class="block py-1 px-3 rounded hover:bg-purple-500 dark:hover:bg-gray-700 {{ request()->routeIs('admin.school.teacher.registration') ? 'bg-purple-500 dark:bg-purple-500' : '' }}">Register 
                     Teacher</a>
    ...
    <div class="mt-10 pt-4 border-t border-gray-300 dark:border-gray-600">
        <h2 class="px-3 text-sm uppercase text-gray-200 dark:text-gray-400">SchoolAdministrator</h2>
        <a href="#" class="flex items-center gap-2 py-2 px-3 rounded hover:bg-purple-400 dark:hover:bg-gray-700">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="size-6">
                <path stroke-linecap="round" stroke-linejoin="round"
                    d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 3.75h.008v.008h-.008v-.008Zm0 3h.008v.008h-.008v-.008Zm0 3h.008v.008h-.008v-.008Z" />
        ...
        <details class="group">
            ...
            <div class="pl-8 mt-1 space-y-1">
                <a href="#" class="block py-1 px-3 rounded hover:bg-purple-500 dark:hover:bg-gray-700">Student</a>
        ...
        <details class="group">
            ...
            <div class="pl-8 mt-1 space-y-1">
                <a href="#" class="block py-1 px-3 rounded hover:bg-purple-500 dark:hover:bg-gray-700">Bill</a>
                <a href="#" class="block py-1 px-3 rounded hover:bg-purple-500 dark:hover:bg-gray-700">Payment</a>
                <a href="#" class="block py-1 px-3 rounded hover:bg-purple-500 dark:hover:bg-gray-700">Payment
                    History</a>
            </div>
        </details>
