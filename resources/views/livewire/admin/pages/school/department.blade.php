<div class="p-6">
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white shadow rounded-lg p-4 flex flex-col justify-between">
            <div>
                <h4 class="text-lg font-bold text-gray-800">{{ $dept->name }}</h4>
                <p class="text-gray-500 text-sm">School ID: {{ $dept->school_id }}</p>
                <p class="text-xs text-gray-400 mt-1">Created {{ $dept->created_at->diffForHumans() }}</p>
            </div>
            <div class="mt-4 flex space-x-2">
                ...
                <button
                    wire:confirm.prompt="Are you sure you want to delete department?\n\nType DELETE to confirm|DELETE"
